...
async function packageList(): Promise {
  ...
  document.querySelectorAll('ul.columnar>li').forEach(async(ele: any) => {
    ...
    let gitRepoInfo = await JSONIfyHttpResponse(http.get(`https://api.github.com/repos/${repoInfo.repo}?client_id=b8257841dd7ca5eef2aa&client_secret=4da33dd6fcb0a01d395945ad18613ecf9c12079e`));
